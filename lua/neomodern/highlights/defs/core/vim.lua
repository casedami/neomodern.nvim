...
M.get = function(palette, base16, opts)
	return {
		...
		Conceal = { guifg = palette.func, guibg = palette.bg },
		...
		CursorLineNr = {
			guifg = palette.fg,
			guibg = opts.gutter.cursorline and palette.line or palette.bg,
		},
		...
		FoldColumn = {
			guifg = palette.comment,
			guibg = (opts.gutter.dark and palette.dim or nil) or palette.bg,
		},
		...
		NormalFloat = { guifg = palette.fg, guibg = palette.bg },
		Pmenu = {
			guifg = palette.comment,
			guibg = palette.bg,
			gui = "none",
		...
		SignColumn = {
			guifg = palette.fg,
			guibg = opts.gutter.dark and palette.dim or palette.bg,
		},
