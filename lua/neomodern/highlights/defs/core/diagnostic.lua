...
M.get = function(palette, _, opts)
	return {
		...
		DiagnosticVirtualTextError = {
			guibg = opts.diagnostics.background and Util.blend(palette.diag_red, 0.1, palette.bg) or nil,
			guifg = palette.diag_red,
		},
		DiagnosticVirtualTextWarn = {
			guibg = opts.diagnostics.background and Util.blend(palette.diag_yellow, 0.1, palette.bg) or nil,
			guifg = palette.diag_yellow,
		},
		DiagnosticVirtualTextInfo = {
			guibg = opts.diagnostics.background and Util.blend(palette.diag_blue, 0.1, palette.bg) or nil,
